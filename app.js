...
form.addEventListener("submit", async function(e) {
  ...
  try {
    ...
    if (currentUser) {
      ...
      // Recargar desde Supabase para tener datos limpios
    ...
    // Si Supabase falla: guardar local de todas formas
    console.log('Error guardando trade:', e.message);
    trades.push(trade);
    try { localStorage.setItem("dygpro_trades_cache", JSON.stringify(trades)); } catch(ex) {}
    render();
  }
